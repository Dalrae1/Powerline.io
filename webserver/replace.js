(function (s, x, k) {
    ...
    function lc() {
        ...
        4 > Z && (L.initSpeedupTutorial(), L.fadeOutGame());
    }
    function Kb() {
        N = !0;
        U || (A = null);
    ...
    function Lb() {
        4 <= Z && T && (Mb || (k("#overlay").css({ "background-color": "rgba(0,0,0,0.4)" }), (Mb = !0)), pa++, 2 < pa && (pa = 0), (nextTipID = pa), (ua = !0));
        setTimeout(Lb, 2500);
    }
    function Hb() {
        if (!debug)
                    ...
                    s.googletag &&
                        (s.googletag.cmd.push(function () {
                            kb &&
                                ...
                                s.googletag && s.googletag.pubads && s.googletag.pubads().refresh && s.googletag.pubads().refresh(s.ads));
                        }),
                        Nb++);
            else {
                k("#mpu-top").show();
    ...
    function ca(a, c, f) {
        var d = z.getBounds();
        return a + f >= d[0].x && a - f <= d[1].x && c + f >= d[0].y && c - f <= d[1].y ? !0 : !1;
    }
    function mb(a, c, f) {
    ...
    var Qb = nc.length,
        ...
        Wa = 0,
        ia = 0,
        Z = s.localStorage.killCount;
    if (void 0 == Z || "undefined" == Z) Z = 0;
    var Fa = 0,
        Ga = !1,
        Mb = !1,
        kb = !0,
        ...
        D,
        S = 1,
        Q = s.localStorage.muteVol;
    if (void 0 == Q || "undefined" == Q) Q = 1;
    var Ca = 0,
        ma = s.localStorage.arrows,
        xa = s.localStorage.speedUpTut;
    xa || (xa = 0);
    var $b = "LOL;EASY!;OOPS!;I DARE YOU!;GOTCHA!;RUN!;TEAM?;YES!;NO!;KILL THE KING!".split(";");
    !xa && 3 < Z && ((xa = 1), (s.localStorage.speedUpTut = xa));
    ...
    var Bb = function () {
        ...
        oc = function () {
            ...
            M.domElement.style.left = 0.25 * a.width + "px";
            M.domElement.style.top = a.height - 18 - 30 + "px";
            x.getElementById("fps").appendChild(M.domElement);
            J = new Stats();
            J.domElement.style.position = "absolute";
            J.domElement.style.left = 0.25 * a.width - 100 + "px";
            J.domElement.style.top = a.height - 18 - 30 + "px";
            x.getElementById("fps").appendChild(J.domElement);
            setInterval(function () {
                J.update();
            }, 1e3 / 60);
            M.domElement.style.visibility = "hidden";
            J.domElement.style.visibility = "hidden";
        };
        ...
        n.hasConnection
            ? U
                ...
                : ((s.localStorage.nick = a),
                  ...
                  (wa.mouseMoved = !1),
                  n.sendNick(a, tb),
                  6 > ub && G && 0 == ub % 3 && G.showTip("Press 'M' to Toggle Sounds", 4e3),
                  tb && (k("#continueTop").hide(), k("#continueBR").hide(), k("#continue").hide(), k("#nickInput").show(), k("#skinPanel").hide(), k("#howto").show(), k("#beta").show(), (tb = !1)))
            : (k("#topGui").hide(), k("#topGuiConnecting").show());
    };
    ...
    s.setCopy = function () {
        ...
        a.select();
        a.focus();
        if (Db()) k("#copyLinkBox").hide(), k("#copyLink").show(), (La = !1);
        else {
            try {
                x.execCommand("copy");
            } catch (c) {}
    ...
    "undefined" !== typeof s.orientation && (s.location.href = "https://play.google.com/store/apps/details?id=com.profusionstudios.powerlineio");
    pc && k("#sndIcon").hide();
    var fb;
    s.onblur = function () {
        debug || (fb = setTimeout(kc, 3e5));
        oa = !1;
        S = 0;
        for (var a in y) {
            var c = y[a];
    ...
    s.localStorage.nick && (k("#nick")[0].value = s.localStorage.nick);
    var ja = 0,
        pa = 0,
        ua = !1;
    setInterval(function () {
    ...
    s.toggleSound = function () {
        ...
        1 == Q ? ((S = Q = 0), G && G.showTip("Sounds Disabled", 3e3)) : 0 == Q && ((S = Q = 1), (a = "images/sound_on.png"), G && G.showTip("Sounds Enabled", 3e3));
        s.localStorage.muteVol = Q;
        k("#soundImg")[0].src = a;
    };
    0 == Q && ((Q = 1), toggleSound());
    ...
    ga.prototype = {
        ...
        setMinWidth: function (a) {
            a != this._minWidth && ((this._minWidth = a), (this._dirty = !0));
        },
        setFont: function (a) {
        ...
        setStrokeWidth: function (a) {
            this._strokeWidth != a && ((this._strokeWidth = a), (this._dirty = !0));
        },
        ...
        setUsingRoundedFrame: function (a) {
            a != this._usingRoundedFrame && ((this._usingRoundedFrame = a), (this._dirty = !0));
        },
    ...
    var qc = function () {
        ...
        rc = function () {
            ...
            a.mousedown = function (a) {
                N || (f++, 2 < f && ((ma = void 0), (f = c = 0)), (Rb = a.clientX), (Sb = a.clientY));
            };
            a.keydown = function (d) {
                ...
                if (N && f) 13 == d.keyCode || 32 == d.keyCode ? clickPlay(s.localStorage.nick) : 27 == d.keyCode && (k("#statsPanel").hide(), k("#basePanel").show(), k("#nick").focus());
                else if (67 == d.keyCode && N && La)
                    setTimeout(function () {
                        Fb();
                    }, 10);
                else if (!N) {
                    32 == d.keyCode && void 0 != ma && 0 != ma && (Ca = 1e3);
                    73 == d.keyCode &&
                        (Xa ? ((M.domElement.style.visibility = "hidden"), (J.domElement.style.visibility = "hidden")) : ((M.domElement.style.visibility = "visible"), (J.domElement.style.visibility = "visible"), n.ping()), (Xa = !Xa));
                    A &&
                        0 < Ja &&
                        ((49 <= d.keyCode && 57 >= d.keyCode) || 48 == d.keyCode
                            ? A.canTalk()
                                ? 49 <= d.keyCode && 57 >= d.keyCode
                                    ? (n.sendTalk(d.keyCode - 49 + 1), G.hideTalkLayer())
                                    : 48 == d.keyCode && (n.sendTalk(10), G.hideTalkLayer())
                                : G.cantTalk()
                            : 84 == d.keyCode && G.toggleTalkLayer());
                    if (debug)
                        if (75 == d.keyCode) n.leave();
                        else if (76 == d.keyCode) Ga || n.bigPicture(), (z.x = 0), (z.y = 0), (z.zoom = 0.3599), (U = !1), (Ga = !0);
                    ...
                    A
                        ...
                        : Ga && ((e = 0.01), d.shiftKey && (e = 0.1), 38 == d.keyCode ? (z.zoom += e) : 40 == d.keyCode && (z.zoom -= e), console.log(z.zoom), console.log(V / 10));
                    70 == d.keyCode
                        ...
                        : 77 == d.keyCode
                        ? toggleSound()
                        : 90 == d.keyCode && debug && U && (xb = !xb);
                    2 < c && ((ma = 1), (s.localStorage.arrows = ma));
                }
            };
            a.keyup = function (a) {};
            this.turn = function (a, f, g, e, b) {
                c++;
                Ab ? ((f = +new Date()), (g = f - Yb), (Yb = f), 30 > g && (e += 30), (e = A.addTurnPoint(a, e)), (f = 10 * e.x), (g = 10 * e.y), n.sendTurnPoint(a, 1 == a || 3 == a ? f / 10 : -g / 10)) : n.sendDirection(a);
            };
        ...
        sc = function () {
            ...
            this.addShot = function (f, d, c, g) {
                if (50 > +new Date() - P && T) {
                    ...
                    if (e) {
                        ...
                        d = b.hitPosition.y - c;
                        g != WEAPON_LASER &&
                            ((g = Math.sqrt(e * e + d * d)), (b.direction = { x: e / g, y: d / g }), (b.curPosition = { x: f, y: c }), (b.finish = !1), (ca(f, c, 100) || ca(b.hitPosition.x, b.hitPosition.y, 100)) && a.push(b));
                        g = areaHeight / 2;
            ...
            this.addMissileImpact = function (a, d) {
                var c = 10 * a,
                    g = 10 * d;
                if (ca(c, g, 100) && 50 > +new Date() - P) {
                    var e = I.createAnimation("explosion");
                    e.setScale(1);
                    e.posX = 10 * a;
                    e.posY = 10 * d;
                    I.runAnimationBehind(e);
                    c = 1 - lb(c, g, O.x, O.y) / PLAY_DISTANCE;
                    D.playSound(SOUND_MISSILE_EXPL, c, 1, cc, null);
                }
            };
            this.addSplash = function (a, d, c, g) {
                if (drawSplashes && !gameEvent.isSpaceWars() && ca(a, d, 100) && 50 > +new Date() - P) {
                    var e = I.createAnimation("splash"),
                        b = I.createAnimation("splashReflex");
                    e.setScale(c);
        ...
        uc = function () {
            ...
            this.draw = function (m) {
                if (0 < d) {
                    var C = 0,
                        k = +new Date() - d;
                    4e3 > k ? (C = 3e3 > k ? 1 : 1 - (k - 3e3) / 1e3) : (d = 0);
                    k = !1;
                    if (!g) {
                        var n = 22;
                        f ? ((e = new ga(36 * r, "#00FFFF", !1, "#00AAAA")), e.setValue(f), e.setUsingRoundedFrame(!0), (k = !0), e.setAddTop(35), e.setShadowBlur(4)) : ((e = null), (n = 35));
                        g = new ga(n * r, "#00FFFF", !1, "#00AAAA");
                        g.setValue(c);
                        g.setUsingRoundedFrame(!k);
                        g.setShadowBlur(3);
                        f || g.setAddTop(-2);
                    }
                    ...
                    var t = g.render();
                    k && e.setMinWidth(t.width);
                    var hb;
                    f && (hb = e.render());
                    m.globalAlpha = C;
                    m.save();
                    m.scale(r, r);
                    hb && m.drawImage(hb, (0.5 * canvas.width) / r - hb.width / 2, (n - 5) / r);
                    m.drawImage(t, (0.5 * canvas.width) / r - t.width / 2, n / r);
                    m.restore();
                    m.globalAlpha = 1;
                }
                0 < q &&
                    ((C = 0),
                    (k = +new Date() - q),
                    4e3 > k ? (3e3 > k ? ((C = k / 200), 1 < C && (C = 1)) : (C = 1 - (k - 3e3) / 1e3)) : (q = 0),
                    (k = !1),
                    b || ((n = v), (b = new ga(n * r, "#00FFFF", !1, "#00AAAA")), b.setValue(l), b.setUsingRoundedFrame(!k), b.setShadowBlur(3), b.setAddTop(-2)),
                    (n = 0.7 * canvas.height),
                    b.setColor("#00FFFF"),
                    ...
                    (m.globalAlpha = 1));
                if (U && A) {
                    (L && M == Fa) || ((L = new ga(15 * r, "#00FFFF", !1, "#00AAAA")), L.setValue("KILLS: " + Fa), (P = L.render()), (Da = M = Fa));
                    (J && I == w) || ((J = new ga(15 * r, "#00FFFF", !1, "#00AAAA")), J.setValue("SCORE: " + w), (S = J.render()), (I = w));
                    T || ((T = new ga(15 * r, "#00FFFF", !1, "#00AAAA")), T.setValue("TALK"), (fa = T.render()));
                    m.save();
                    m.scale(r, r);
                    if (0 < Ja) {
                        var ra = A.talkStamina / 255;
                        255 == A.talkStamina && 255 > Z && (s.localStorage.talk ? s.localStorage.talk++ : (s.localStorage.talk = 1), 7 >= s.localStorage.talk && 0 == s.localStorage.talk % 2 && G.showTip("Press T to talk", 4e3));
                        Z = A.talkStamina;
                        m.globalAlpha = 1 == ra ? 0.3 : 0.1 + 0.6 * aa;
                        var dc = canvas.height / r - P.height - S.height - fa.height - 5;
                        m.drawImage(fa, 5, dc);
                    }
                    m.globalAlpha = 0.3;
                    m.drawImage(P, 5, canvas.height / r - P.height - S.height - 5);
                    m.drawImage(S, 5, canvas.height / r - P.height - 5);
                    0 < Ja && this.drawTalkWaitFx(m, fa.width + 5 + 8, dc + 13, 4, ra);
                    m.globalAlpha = 1;
                    m.restore();
                }
                H && ((u = x.createElement("canvas")), (C = u.getContext("2d")), this.renderLeaderboard(C, u), (H = !1));
                u && U && this.drawLeaderboard(m);
                y &&
                    ((0 < Ka && za) || !za || 0 < E) &&
                    (null == D && ((C = parseInt(20 * r) + 1), (z = new ga(C, F, !1, F)), z.setValue(y), z.setUsingRoundedFrame(!0), z.setRoundedFrameStyle(B), z.setShadowBlur(2), (D = z.render())),
                    m.drawImage(D, da / 2 - D.width / 2, 1.1 * D.height * (Y ? 1 - E / 300 : E / 300) - D.height));
                !N && 0 < Ja && ka.draw(m);
                a != r && (a = r);
            };
            ...
            this.update = function (b) {
                0 < E ? ((E -= b), 0 >= E && !Y && (y = null)) : (E = 0);
                za && (Ka -= b);
                za && 0 >= E && Y && 0 >= Ka && ((Y = !1), (E = 300));
            ...
            this.renderLeaderboard = function (b, a) {
                ...
                n += d + g + d + 12;
                f = 6 + d + g + d;
                for (var h = C.length, ib = 0, jb = !1, R = 0; R < h; R++) {
                    var K = C[R];
                ...
                b.fillStyle = "#003a3a";
                b.globalAlpha = 0.3;
                Ra(b, 6, 6, k - 12, n - 12, 15 * r);
                b.globalAlpha = 1;
                b.shadowColor = "#337777";
                b.shadowBlur = 6;
                b.fillStyle = "#337777";
                b.globalAlpha = 0.5;
                mc(b, 6, 6, k - 12, 32 * r, 15 * r);
                b.globalAlpha = 1;
                b.font = g + "px 'proxima-nova-1','proxima-nova-2', Arial Black";
                b.textBaseline = "middle";
                q = b.measureText("LEADERBOARD").width;
                b.fillStyle = "#09ffff";
                b.shadowColor = "#09ffff";
                b.shadowBlur = 6;
                b.fillText("LEADERBOARD", k / 2 - q / 2, d + 6 + g / 2);
                b.shadowBlur = 2;
                ...
                for (R = 0; R < h; R++)
                    if ((K = C[R])) {
                        var v = 0 == R && 0 < qa,
                            u,
                            H = R + 1 + ". ";
                        v && ((u = b.measureText(H).width), (H += "    "));
                        var H = H + Ba(K.nick),
                            B = 0;
                        b.fillStyle = $ == K.id ? "#09ffff" : "rgba(0,255,255,0.4)";
                        b.font = g;
                        q = b.measureText(H).width;
                        b.fillText(H, 6 + d, f + B + c / 2);
                        q = b.measureText(K.score).width;
                        b.fillText(K.score, k - d - q - 6, f + B + c / 2);
                        v && (b.save(), b.translate(6 + d + u + 10, f + B + c / 2 - 1), (K = 1), ba || (K = 0.5), b.scale(0.8 * K, 0.8 * K), t.frames.crown.draw(b), b.restore());
                        f += c + l;
                    }
                !jb && A && ((b.fillStyle = "#09ffff"), (H = ra + ". " + Ba(A.nick)), (q = b.measureText(H).width), b.fillText(H, 6 + d, f + B + c / 2), (q = b.measureText(w).width), b.fillText(w, k - d - q - 6, f + B + c / 2));
            };
            this.drawLeaderboard = function (b) {
                b.drawImage(u, da - k - 5, 5);
            };
        ...
        Cb = function () {
            ...
            this.processPoint = function (b) {
                ...
                var a = va(this.x, this.y, b.x, b.y),
                    e = Oa(b.d);
                this.x = b.x + e.x * a;
                this.y = b.y + e.y * a;
                0 < V && ((e = this.waitingPoints[0]), (b = va(e.x, e.y, b.x, b.y)), a > b && this.processPoint(e));
            };
            this.update = function (a) {
                if (this.beingDeleted)
                    if (x) (this.snakeScale -= 0.1), 0 > this.snakeScale && (this.id == $ && ((wa.direction = 1), ($ = 0), (A = null), (Ma = this.killReason), this.killedByID == this.id && (Ma = 3)), delete y[this.id], this.cleanup());
                    else {
                        var c = va(this.x + u.x, this.y + u.y, k.x, k.y);
                        c > r ? ((x = !0), this.points.unshift({ x: this.x, y: this.y }), (this.x = k.x), (this.y = k.y)) : ((this.x += u.x), (this.y += u.y));
                        r = c;
                        ea += a;
                        3e3 < ea && !x && (debug && console.log("bf"), (x = !0));
                    }
                else {
                    n = m;
                    m = mb((P - this.lastUpdateTime) / Aa, 0, 1);
                    if (n == m) return;
                    this.prevX = this.x;
                    this.prevY = this.y;
                    var R = (c = 0),
                        c = m * (this.dstX - this.origX) + this.origX,
                        R = m * (this.dstY - this.origY) + this.origY;
                    ...
                    if (0 < V) {
                        ...
                        va(this.x, this.y, K.x, K.y);
                        var H = !1;
                        if (1 == this.direction || 3 == this.direction) {
                            if ((this.prevY <= K.y && this.y >= K.y) || (this.y <= K.y && this.prevY >= K.y)) H = !0;
                        } else if ((this.prevX <= K.x && this.x >= K.x) || (this.x <= K.x && this.prevX >= K.x)) H = !0;
                        H && this.processPoint(K);
                    }
                    c = Math.abs(c);
                    R = Math.abs(R);
                    J = L;
                ...
                E && E.update(a);
                30 < q || v ? E.enabled || E.setEnabled(!0) : 30 >= q && E.enabled && E.setEnabled(!1);
                this.playSounds && (na = Ob(this.x, this.y));
                T ? N && (na *= 0.3) : (na = 0);
                fa && this.playSounds && ((ka -= 0.01), 0 > ka && (ka = 0), (D.sound._nodeById(fa).bufferSource.playbackRate.value = 0.8 + (q / 100) * 1.5 - ka), D.sound.volume((ec + (q / 100) * (vc - ec)) * na * S, fa));
                aa && this.playSounds && ((c = Math.max(0, (q - 30) / 70)), D.sound.volume(c * wc * na * S, aa));
                W && this.playSounds && (D.sound._nodeById(W), ga ? D.sound.volume(xc * na * S, W) : D.sound.volume(0, W));
                f && !xa && U && A == this && ((ja += a), 2e3 < ja && ((xa = 1), (s.localStorage.speedUpTut = 1)));
                a = (a / 1e3) * 20;
                0 < ca ? ((sa += a), (a = 0.75 * Math.PI), sa > a && (sa = a)) : ((sa -= a), 0 > sa && (sa = 0));
            };
            ...
            this.drawSpark = function (b, a, e, d, l, g) {
                B[l] && (g.save(), (g.globalAlpha = c), g.translate(b, a), g.rotate(e), g.scale(d, d), g.translate(0, -(B[l].height / 2)), B[l].draw(g), g.restore());
            };
            ...
            this.getPointList = function (b) {
                for (var a = this.points.length, e = this.x, d = this.y, l = 0, g = b.length, c = b[0], f = [], q = 0; q < a; q++) {
                    p = this.points[q];
                    var v = va(e, d, p.x, p.y),
                        l = l + v;
                    if (l > c) {
                        var h = l - c,
                            c = e - p.x,
            ...
            this.calcRenderPoints = function () {
                var b = [],
                    ...
                    c = 0,
                    g = { x: this.x, y: this.y };
                $ == this.id || this.tutorial || (c = (Math.max(Wa / 2 + da / 2 - db + Zb, 0) * this.lastSpeed) / Aa);
                for (var f = !1, q, v = 0; v < a; v++) {
                    q = this.points[v];
                    var h = va(d, l, q.x, q.y),
                        e = e + h;
                    if (f)
                        if (e > this.curLength) {
                            f = e - this.curLength;
                            ...
                            q.x *= f;
                            q.y *= f;
                            b.push({ x: d - q.x, y: l - q.y });
                            break;
                        } else b.push({ x: q.x, y: q.y });
                    else if (e > c) {
                        f = e - c;
                        e = d - q.x;
                        q = l - q.y;
            ...
            this.drawAfter = function (b) {
                    ...
                    if (0 < w) {
                        ...
                        if (g) {
                            ...
                            0 == F &&
                                ...
                                (b.globalAlpha = c),
                                b.translate(s, r),
                                b.rotate(k + Math.PI / 2),
                                (k = u / t.frames.lightning1.height),
                                (m = Math.random()),
                                (r = s = 1),
                                0.25 > m ? (s = -1) : 0.5 > m ? (r = -1) : 0.75 > m && (r = s = -1),
                                b.scale(k * s, k * r),
                                ra[v].draw(b),
                                b.restore());
                            k = !1;
                            ...
                            40 < q && (m += ((q - 40) / 60) * 0.3);
                            k && g.drawSpark(d - C, h - n, B, m, v, b);
                            5 > u && g.drawSpark(d + C, h + n, B, -m, v, b);
                        }
                    }
                    F++;
                    2 > l && (l = 2);
                    F > l && ((F = 0), this.playSounds && D.playSound(yc, zc * na * S, 1, ta, null));
                }
                ...
                a = 60;
                this.beingDeleted && (a = 100);
                ia && ((a = 100), (b.lineWidth = (e + 1) * this.snakeScale));
                b.strokeStyle = "hsl(" + this.hue + ", 100%, " + a + "%)";
                ba && (b.shadowBlur = 15);
                this.drawTail(this.renderedPoints, b);
                ia && ((b.lineWidth = e * this.snakeScale), (b.strokeStyle = "hsl(0, 100%, 0%)"), this.drawTail(this.renderedPoints, b));
                4e3 < this.curLength &&
                    ba &&
                    ((a = 1),
                ...
                30 < q && ((e = (q - 30) / 70), 0 == I && (e *= 0.5), (b.globalAlpha = 0.4 * e * c), b.scale(0.9, 0.9), za.draw(b), b.scale(1 / 0.9, 1 / 0.9), (b.globalAlpha = 1 * c));
                5 < q && ((e = (q - 5) / 50), 50 < q && (e = 1), (e *= 0.6), b.scale(e, e), M.draw(b), (b.globalAlpha = 1 * c), b.scale(1 / e, 1 / e), I++, 2 < I && (I = 0));
                e = this.snakeScale * O;
            ...
            this.drawInfo = function (b) {
                if (void 0 != this.headPos && !this.beingDeleted) {
                    ...
                    var e = 20,
                        d = 0.5 * (O - 1) + 1,
                        l = 0.55 * d;
                    this.id == qa && (b.translate(0, -e * d), b.scale(l, l), t.frames.crown.draw(b), b.scale(1 / l, 1 / l), b.translate(0, e * d), (e += 20));
                    la && ((l = 0.45 * d), b.translate(0, -e * d), b.scale(l, l), t.frames.trophy.draw(b), b.scale(1 / l, 1 / l), b.translate(0, e * d), (e += 20));
                    0 < X && ((l = 0.35 * d), b.translate(0, -e * d), b.scale(l, l), this.drawKillStreakIcon(b, X), b.scale(1 / l, 1 / l), b.translate(0, e * d));
            ...
            this.updateNetwork = function (a, c, u) {
                ...
                0 == V && 0 >= Q
                    ...
                    : ((this.origX = this.x), (this.origY = this.y), (m = Oa(this.direction)), (this.dstX += m.x * this.lastSpeed), (this.dstY += m.y * this.lastSpeed));
                k = a.getUint8(c, !0);
                c += 1;
                if (k & 1) {
                    a.getFloat32(c, !0);
                ...
                k & 2
                    ? ((m = a.getFloat32(c, !0)), (c += 4), (C = -a.getFloat32(c, !0)), (c += 4), (w = a.getUint16(c, !0)), (c += 2), (g = d), (e = h), (b = 10 * m), (l = 10 * C), f || ((d = b), (h = l), (g = b), (e = l), (f = !0)))
                    : (f = !1);
                v = k & 4 ? !0 : !1;
                k & 8 && ((da = a.getUint16(c, !0)), (c += 2));
                la = k & 16;
                k & 32 ? ((X = a.getUint16(c, !0)), (c += 2), ma != X && A == this && U && ((ma = X), G.addSpecialMessage(X + " PLAYER KILL STREAK", 25))) : (X = 0);
                k & 64 ? ((ca = a.getUint8(c, !0)), (c += 1), ua != ca && ((pa = this.getTalkTextByTalkID(ca)), (ua = ca))) : (ca = 0);
                this.talkStamina = a.getUint8(c, !0);
                c += 1;
                q = (a.getUint8(c, !0) / 255) * 100;
                c += 1;
                A == this && ((m = Math.max(0, Math.min(1, (this.curLengthDst - pb) / Ub))), (wb = Ta - (Ta - Tb) * m));
                if (u) {
                    "demogorgon" == this.nick && (ia = !0);
                    ...
                    this.points = [];
                    for (m = 0; m < curPointCount; m++) (u = a.getFloat32(c, !0)), (c += 4), (k = -a.getFloat32(c, !0)), (c += 4), this.points.push({ x: 10 * u, y: 10 * k });
                    this.hue = a.getUint16(c, !0);
                    c += 2;
                    a.getUint8(c);
                    c += 1;
                    Y = "hsl(" + this.hue + ", 100%, 50%)";
                    a = "hsl(" + this.hue + ", 100%, 90%)";
                    m = "hsl(" + this.hue + ", 100%, 70%)";
                    H = t.frames.head_dot.renderTintedFrame("#FFFFFF");
                    M = t.frames.glow.renderTintedFrame(Y);
                    za = t.frames.glow_hard.renderTintedFrame(a);
                    ra.push(t.frames.lightning1.renderTintedFrame(Y));
                    ra.push(t.frames.lightning2.renderTintedFrame(Y));
                    ra.push(t.frames.lightning3.renderTintedFrame(Y));
                    B.push(t.frames.spark0.renderTintedFrame(m));
                    B.push(t.frames.spark1.renderTintedFrame(m));
                    B.push(t.frames.spark2.renderTintedFrame(m));
                    a = t.frames.particleDot.renderTintedFrame("hsl(" + this.hue + ", 100%, 80%)");
                    E = new fc();
                    E.particleFrame = a;
                    E.init(10, this.x, this.y);
                    this.playSounds &&
                        (D.playSound(Ac, 0, 1, ta, function (b) {
                            fa = b;
                        }),
                        D.playSound(Bc, 0, 1, ta, function (b) {
                            aa = b;
                        }),
                        D.playSound(Cc, 0, 1, ta, function (b) {
                            W = b;
                        }));
                } else if (((u = a.getUint8(c, !0)), c++, 0 < u)) {
                    k = [];
                    for (m = 0; m < u; m++) (C = a.getFloat32(c, !0)), (c += 4), (F = -a.getFloat32(c, !0)), (c += 4), k.push({ x: 10 * C, y: 10 * F });
                    if (this.id == $ && Ab) {
                        a = Math.min(Q, u);
                        0 > a && (a = 0);
                        C = u - Q;
                        ...
                        this.playSounds && D.playSound(gc, hc * na * S, 1, ta, null);
                    }
                }
                a = Q;
                0 > a && (a = 0);
            ...
            this.fixPoints = function (b, a, e) {
                var d = va(a, e, this.dstX, this.dstY),
                    c = va(this.origX, this.origY, a, e);
                b = Oa(b);
                var l = b.y * d;
                this.dstX = a + b.x * d;
                this.dstY = e + l;
            ...
            this.findLastWaitingPoint = function (b) {
                for (var a = this.x, e = this.y, d = 0, c = 0; c < V; c++) (b = this.waitingPoints[c]), (d += va(a, e, b.x, b.y)), (a = b.x), (e = b.y), (b = b.d);
                return { x: a, y: e, dist: d, direction: b };
            };
            this.addTurnPoint = function (b, a) {
                300 < Wa && (a += Wa - 300);
                var e = (a * this.lastSpeed) / Aa,
            ...
            this.deleteNetwork = function (b, a) {
                this.id == $ && 4 <= Z + 1 && ((cb = this.killedByID), (ya = 30));
                this.killedByID == $ && this.id == qa && this.id != $ && U && G.addSpecialMessage("YOU KILLED THE KING!", 30);
                if (oa && 0 != this.killReason) {
                    this.beingDeleted = !0;
                    this.id == $ && z.shake(7 + 0.13 * q);
                    var e = b.getFloat32(a, !0);
                    a += 4;
                    var d = -b.getFloat32(a, !0);
                    a += 4;
                    3 == this.killReason ? (x = !0) : ((k.x = 10 * e), (k.y = 10 * d), (u.x = this.x - this.prevX), (u.y = this.y - this.prevY), (u = Pa(u.x, u.y)), (u.x *= J), (u.y *= J));
                    this.playSounds && D.playSound(Dc, Ec * na * S, 1.1, ta, null);
                } else this.id == $ && ((wa.direction = 1), ($ = 0), (A = null), (Ma = this.killReason)), (a = a + 4 + 4), delete y[this.id], this.cleanup();
                return a;
            };
            this.resume = function () {};
            this.cleanup = function () {
                Ua--;
                fa && this.playSounds && (D.sound.stop(fa), D.sound.stop(aa), D.sound.stop(W), (aa = fa = null));
            };
            ...
            this.onBlur = function () {
                this.playSounds && (D.sound.volume(0, fa), D.sound.volume(0, aa), D.sound.volume(0, W));
            };
            ...
            this.update = function (a) {
                ...
                if (this.beingDeleted) {
                    ...
                    1 > b && ((b += 0.03 * a), 1 < b && (b = 1)),
                        (a = mb((P - this.lastUpdateTime) / Aa, 0, 1)),
                        (this.prevX = this.x),
                        (this.prevY = this.y),
            ...
            this.deleteNetwork = function (b, a) {
                oa
                    ? ((this.beingDeleted = !0),
                      ...
                      0 < this.killedByID && this.playSounds && ((lastDistVolume = Ob(this.x, this.y)), D.playSound(Fc, Gc * lastDistVolume * S, 1.5, ta, null)))
                    : delete y[this.id];
                return a;
            };
            this.resume = function () {};
        ...
        Hc = function () {
            ...
            this.drawLimits = function (g) {
                ...
                g.save();
                g.translate(la, X);
                d + la <= e[1].x && ((g.fillStyle = "#023139"), g.fillRect(d, -d - 1e3, 1e3, 2e3 + 2 * d));
                -d + la >= e[0].x && ((g.fillStyle = "#023139"), g.fillRect(-d - 1e3, -d - 1e3, 1e3, 2e3 + 2 * d));
                -ha / 2 + X > e[0].y && ((g.fillStyle = "#023139"), g.fillRect(-d - 2, -d - 1e3, 2 * d + 4, 1e3));
                ha / 2 + X < e[1].y && ((g.fillStyle = "#023139"), g.fillRect(-d - 2, d, 2 * d + 4, 1e3));
                d + la <= e[1].x && g.drawImage(c, d - 9, -d - 9);
                -d + la >= e[0].x && g.drawImage(c, -d - 9, -d - 9);
                -ha / 2 + X > e[0].y && g.drawImage(f, -d - 9, -d - 9);
                ha / 2 + X < e[1].y && g.drawImage(f, -d - 9, d - 9);
                g.restore();
            };
            this.draw = function (a) {
                var e = z.getBounds(),
        ...
        Ic = function () {
            ...
            this.draw = function (f) {
                ...
                f.drawImage(a, d - 20 * r, h - 20 * r);
                if (A) {
                    for (var e = A.renderedPoints, g = [], b = e.length, l = 0; l < b; l++) {
                        var q = e[l].x + V / 2 - la,
                            v = e[l].y + ha / 2 - X,
                            q = q / V,
                            v = v / ha;
                    ...
                    f.strokeStyle = "hsl(" + A.hue + ", 100%, 50%)";
                    f.lineWidth = 2;
                    e = g.length;
                    q = g[0].x;
                    v = g[0].y;
                    f.beginPath();
                    f.moveTo(d + 120 * q * r, h + 120 * v * r);
                    for (l = 1; l < e; l++) (q = g[l].x), (v = g[l].y), f.lineTo(d + 120 * q * r, h + 120 * v * r);
                    f.stroke();
                    0 < qa && ((q = Ha + V / 2 - la), (v = Ia + ha / 2 - X), (q /= V), (v /= ha), f.translate(d + 120 * q * r, h + 120 * v * r), f.scale(0.5, 0.5), t.frames.crown.draw(f));
                }
                f.restore();
            };
            this.update = function (a) {};
        ...
        Jc = function () {
            ...
            function f(a) {
                for (var b = 1; ; ) {
                    var c = a.getUint16(b, !0),
                        b = b + 2;
                    if (0 == c) {
                        b != a.byteLength && ((qa = a.getUint16(b, !0)), (b += 2), 0 < qa && ((c = a.getFloat32(b, !0)), (b += 4), (a = -a.getFloat32(b, !0)), (Za = Ha), ($a = Ia), (ab = 10 * c), (bb = 10 * a), (Xb = P)));
                        break;
                    }
                    ...
                    switch (d) {
                        case 0:
                            (g = y[c]) ? (b = g.updateNetwork(a, b, !1)) : console.log("entity with id: " + c + " not found");
                            break;
                        case 1:
                            var d = a.getUint8(b, !0),
                                b = b + 1,
                            ...
                            (g = u) ? ((g.nick = h), (g.id = c), (y[c] = g), (b = g.updateNetwork(a, b, !0))) : console.log("Unable to create entity. Entity Type is: " + d);
                            break;
                        case 2:
                            d = a.getUint16(b, !0);
                            b += 2;
                            ...
                            (g = y[c])
                                ? ((g.killReason = h),
                                  ...
                                  c && U && ((U = !1), (A = null), (wa.angle = Math.PI), (wa.throttle = 0), Z++, (Fa = 0), (s.localStorage.killCount = Z), G.fastHideTalkLayer(), Ga || Kb()))
            ...
            this.processConfig = function (a, b) {
                ...
                V = 10 * g;
                ha = 10 * g;
                d && ((la = 10 * a.getFloat32(c, !0)), (c += 4), (X = 10 * a.getFloat32(c, !0)), (c += 4));
                debug && console.log(V / 10);
                Ta = a.getFloat32(c, !0);
                c += 4;
                Tb = a.getFloat32(c, !0);
                c += 4;
                Ub = 10 * a.getFloat32(c, !0);
                c += 4;
            ...
            this.processMessage = function (e) {
                ...
                else if (160 == b || 176 == b) this.processConfig(e, b);
                else if (161 == b) {
                    var b = 1,
                        d = e.getUint32(b, !0),
                        b = b + 4;
            ...
            this.sendHello = function () {
                ...
                b.setUint16(1, (da / 10) * 1, !0);
                b.setUint16(3, (ea / 10) * 1, !0);
                d.send(a);
            };
            ...
            this.sendResize = function () {
                ...
                var c = 1;
                ba || (c = 2);
                b.setUint16(1, (da / 10) * 1 * c, !0);
                b.setUint16(3, (ea / 10) * 1 * c, !0);
                d.send(a);
            };
        ...
        Oc = function (a) {
            ...
            f.update = function (a) {
                ...
                for (var c in y) {
                    var d = y[c];
                    d.tutorial || (d.update(a), c == $ && (A = y[c]));
                }
                justTurned = !1;
                z.update(a);
                I.update(a);
                O = { x: (h.width / 2 + (z.x * z.zoom - h.width / 2)) / z.zoom, y: (h.height / 2 + (z.y * z.zoom - h.height / 2)) / z.zoom };
                0 < cb && 1 < ya && ((ya -= 0.2), 1 > ya && (ya = 1));
                Ya.update(a);
                zb.update(a);
                0 < qa && this.updateOffscreenInfo(1);
                ma || N ? 1 == ma && 0 < e && ((e -= (a / 1e3) * 3), 0 >= e && (e = 0)) : ((e += (a / 1e3) * 3), 1 < e && (e = 1));
                1 == ma && ((xa && !(0 < Ca)) || N ? 1 == xa && 0 < b && ((b -= (a / 1e3) * 3), 0 >= b && (b = 0)) : ((Ca -= a), 0 > Ca && (Ca = 0), (b += (a / 1e3) * 3), 1 < b && (b = 1)));
            ...
            f.draw = function (a) {
                if (t.loaded && (z.setupContext(g), Ya.draw(g), Vb)) {
                    if (T) {
                        for (var c in y) {
                            var d = y[c];
                            d.tutorial || (d.setAlpha(q), d.draw(g, a));
                        }
                        for (c in y) (d = y[c]), d.tutorial || d.drawAfter(g, a);
                        for (c in y) y[c].drawInfo(g);
                        I.drawBehind(g);
                    }
                    T && (I.drawLayer2(g), I.draw(g), I.drawExplosions(g), yb.draw(g), Ya.drawLimits(g));
                    U && A && A.drawInput(g);
                    0 < qa && this.drawOffscreenInfo(g, 1);
                    z.startUILayer();
                    l.isInitialized && l.draw(g);
                    0 < e && !N && t.keysImage && (g.save(), (g.globalAlpha = e), g.scale(r, r), g.translate((0.5 * da) / r, (0.825 * ea) / r), g.drawImage(t.keysImage, -t.keysImage.width / 2, -t.keysImage.height / 2), g.restore());
                    0 < b && !N && t.boostImage && (g.save(), (g.globalAlpha = b), g.scale(r, r), g.translate((0.5 * da) / r, (0.825 * ea) / r), g.drawImage(t.boostImage, -t.boostImage.width / 2, -t.boostImage.height / 2), g.restore());
                    U && zb.draw(g);
                    G.draw(g);
                }
            };
            f.updateOffscreenInfo = function (b) {
                if (null != A) {
                    ...
                    Ha = a * (ab - Za) + Za;
                    Ia = a * (bb - $a) + $a;
                    Wb != qa && ((Ha = ab), (Ia = bb), (Za = ab), ($a = bb), (Wb = qa));
                    l = Ha;
                    h = Ia;
                    if (A && !ca(l, h, 50)) {
                        var a = O.x - l,
            ...
            f.resize = function (b) {
                C();
                n.hasConnection && (H && clearTimeout(H), (H = setTimeout(n.sendResize, 200)));
            };
            ...
            var C = function () {
                ...
                r = 0.92 * Math.max(ea / 850, da / 1500);
                r *= s.devicePixelRatio / sb;
                ia = Math.min(1, a / 850);
                c = 440 * ia;
                if (0 < c) {
                    var d = "translate(-50%,0%) scale(" + ia + ")";
                ...
                J && ((J.domElement.style.position = "absolute"), (J.domElement.style.left = 0.31 * h.width * b + "px"), (J.domElement.style.top = h.height * b - 18 - 30 + "px"));
                M && ((M.domElement.style.position = "absolute"), (M.domElement.style.left = (0.31 * h.width - 100 / b) * b + "px"), (M.domElement.style.top = h.height * b - 18 - 30 + "px"));
            };
            f.getMouseWorldPosition = function () {
                var b = 1;
                ba || (b = 2);
                return { x: (Rb + (z.x * z.zoom - (h.width * b) / 2)) / z.zoom, y: (Sb + (z.y * z.zoom - (h.height * b) / 2)) / z.zoom };
            };
            (function () {
                h = a;
                g = h.getContext("2d");
        ...
        Lc = function (a, c, f, d) {
            ...
            this.update = function (b) {
                ...
                if (U || N) {
                    ...
                    var a = h.x,
                        c = h.y;
                    if (A && !Ga) A.beingDeleted || ((a = A.x), (c = A.y)), (T = !0), 4 > Z && L.resetAlpha();
                    else if (0 < cb) {
                        var d = y[cb];
                        d && ((a += (d.x - a) / ya), (c += (d.y - c) / ya));
                    }
                    h.x = a;
                    h.y = c;
                    this.applyShake(b);
        ...
        gb = function () {
            ...
            this.generateTintImage2 = function (b, d, f, v) {
                ...
                for (var u = n.getImageData(0, 0, this.width, this.height), m = u.data, s = m.length, r = 0; r < s; )
                    (m[r] = m[r++] * (1 - v) + b * v), (m[r] = m[r++] * (1 - v) + d * v), (m[r] = m[r++] * (1 - v) + f * v), (m[r] = 0.8 * m[r++]);
    ...
    var Qc = function () {
        ...
        fc = function () {
            ...
            this.init = function (l, q, k) {
                d = l;
                b = e = g = h = 0;
                a = q;
                c = k;
                for (l = 0; l < d; l++) (q = new Qc()), this.resetParticle(q), (q.active = !1), (q.time = 9999), f.push(q);
            };
        ...
        Rc = function () {
            ...
            this.update = function (n) {
                ...
                3 < f && (f = 3);
                k += n;
                500 < k && 2300 >= k ? (l.debreeAge = (k - 500) / 2300) : 2300 < k && 2500 >= k ? (l.alpha = (2500 - k) / 200) : 2500 < k && (delete l, (this.deleting = !0));
        ...
        Mc = function () {
            ...
            a.buildSnakePacket = function (a) {
                ...
                c += 1;
                if (a.isFull) {
                    for (var e = 0; e < d; e++) b.setFloat32(c, a.points[e].x, !0), (c += 4), b.setFloat32(c, a.points[e].y, !0), (c += 4);
                    b.setUint16(c, a.hue, !0);
                    c += 2;
                    b.setUint8(c, 0, !0);
                } else for (d = a.newPointCount, b.setUint8(c, d, !0), c += 1, e = 0; e < d; e++) b.setFloat32(c, a.newPoints[e].x, !0), (c += 4), b.setFloat32(c, a.newPoints[e].y, !0), (c += 4);
                return b;
            };
            a.update = function (t) {
                if (this.isInitialized && !(100 < t)) {
                    G && ((E += t), 1e3 < E && ((E = 0), (D = !0), (G = !1)));
                    7 == l && D ? ((z -= 0.04), 0 > z && ((z = 0), a.clear(), a.init(), (nextTipID = 0), (ua = !0))) : ((z += 0.04), 1 < z && (z = 1));
                    c.setAlpha(z);
                    f.setAlpha(z);
                    if (d > Aa) {
                        if (void 0 != y[c.id])
                            if (4 <= l && h > s) {
                                if (!J) {
                                    ...
                                    for (var F = 0; 20 > F; F++) {
                                        var B = s - 30 + 1.5 * F,
                                            ...
                                            B = this.initFood(B, 0, 295 + 50 * Math.random());
                                        B.speedX = A;
                                        B.speedY = w;
                                    }
                                }
                                ...
                                (h += 0.5),
                                    ...
                                    c.updateNetwork(w, 0, !1);
                        w = { newPointCount: 0 };
                        0 == l && (-2.6 < b ? ((l = 1), k++, (w.newPointCount = 1), (w.newPoints = []), w.newPoints.push({ x: e, y: b })) : (b += 0.5));
                        A = F = !1;
                        if (1 == l || 3 == l)
                            if (((e += r), (e < h - 10 && 1 == l) || (e < h && 3 == l))) (r += 0.03), (F = !0), 5 < r && (r = 5), (n += 3), 200 < n && (n = 200), (w.flags |= 2), (w.rubPoint = { x: e - 0.06, y: g }), (A = !0);
                            else if ((e >= h - 10 && 1 == l) || e >= h + 4) (e -= r), 1 == l ? (l = 2) : ((l = 4), (s = e)), k++, (w.newPointCount = 1), (w.newPoints = []), w.newPoints.push({ x: e, y: b });
                        F || ((r -= 0.01), 0.5 > r && (r = 0.5), (n -= 1), 0 > n && (n = 0));
                        if (2 == l || 4 == l)
                            2 == l
                                ? -1.2 < b
                                    ? ((l = 3), k++, (w.newPointCount = 1), (w.newPoints = []), w.newPoints.push({ x: e, y: b }), (nextTipID = 1), (ua = !0))
                                    : (b += r)
                                : 0.8 < b
                                ? ((l = 5), k++, (w.newPointCount = 1), (w.newPoints = []), w.newPoints.push({ x: e, y: b }))
                                : (b += r);
                        5 == l && (e > h + 12 ? ((l = 6), k++, (w.newPointCount = 1), (w.newPoints = []), w.newPoints.push({ x: e, y: b })) : (e += r));
                        6 == l && (1 > b ? ((l = 7), k++, (w.newPointCount = 1), (w.newPoints = []), w.newPoints.push({ x: e, y: b }), (nextTipID = 2), (ua = !0)) : (b -= r));
                        if (7 == l) {
                            e -= r;
                            for (var I = m.length, F = 0; F < I; F++)
                                (B = m[F]), f.x < B.x + 30 && void 0 != y[B.id] && !B.beingDeleted && ((B.beingDeleted = !0), (B.beginGrabX = B.x), (B.beginGrabY = B.y), B.setKilledBy(f.id), (u += 1.1));
                        }
                        w.x = e;
                        w.y = b;
                        w.lastLen = 2;
                        ...
                        w.extraSpeed = n;
                        w = this.buildSnakePacket(w);
                        f.updateNetwork(w, 0, !1);
                        A && f.setRubSnakeID(x);
                        I = m.length;
                        for (F = 0; F < I; F++)
                            (B = m[F]), (w = {}), (B.speedX *= 0.9), (B.speedY *= 0.9), (w.x = B.x / 10 + B.speedX), (w.y = -B.y / 10 + B.speedY), (w.isFull = !1), (w = this.buildFoodPacket(w)), B.updateNetwork(w, 0, !1);
                        d -= Aa;
                    }
                    void 0 != y[c.id] && c.update(t);
                    void 0 != y[f.id] && f.update(t);
                    I = m.length;
                    for (F = 0; F < I; F++) void 0 != y[m[F].id] && m[F].update(t);
                    d += t;
                }
            };
            a.draw = function (a) {
                ...
                var d = 1.4 / b;
                a.save();
                a.translate(da / 2 - (435 * ia) / b, 0.5 * ea - (209 * ia) / b);
                a.scale(d * ia, d * ia);
            ...
            a.initSnake = function (a) {
                ...
                0 == a
                    ...
                    : ((f = new Cb()),
                      ...
                      (d.hue = 170),
                      (a = this.buildSnakePacket(d)),
                      f.updateNetwork(a, 0, !0));
            };
            a.clear = function () {
                if (this.isInitialized) {
                    this.isInitialized = !1;
                    void 0 != y[x] && (y[x].cleanup(), delete y[x]);
                    void 0 != y[A] && (y[A].cleanup(), delete y[A]);
        ...
        tc = function () {
            ...
            this.draw = function (a) {
                ...
                0.99 < f ||
                    ...
                    A && (255 > A.talkStamina ? (a.fillText("CANT TALK YET", 20, 15), G.drawTalkWaitFx(a, 160, 8, 4, A.talkStamina / 255), (a.globalAlpha = 0.5)) : a.fillText("PRESS A NUMBER", 20, 15)),
                    (a.shadowBlur = 0),
                    a.drawImage(c, 0, 0),
                    (a.globalAlpha = 1));
            };
            this.preRender = function (a, c) {
                ...
                for (var e = 0; 10 > e; e++) {
                    ...
                    b.moveTo(0, k + n);
                    b.lineTo(0, k + 30 - n);
                    b.quadraticCurveTo(0, k + 30, 0 + n, k + 30);
                    b.lineTo(35, k + 30);
                    b.lineTo(35, k);
                    b.lineTo(0 + n, k);
                    b.quadraticCurveTo(0, k, 0, k + n);
                    b.closePath();
                    b.fill();
                    a.globalAlpha = 1;
                    a.fillStyle = "rgba(0, 255, 255, 1.0)";
                    ...
                    b = $b[e];
                    k = a.measureText(b).width;
                    a.fillText(b, 107.5 - k / 2, f + 31 * e + 5 + 15);
                }
                a.globalAlpha = 1;
                a.shadowBlur = 0;
            };
    ...
    s.onload = function () {
        ...
        Modernizr.canvas && Modernizr.websockets
            ? (null == L &&
                  ...
                  s.addEventListener("resize", L.resize, !1),
                  (wa = new rc()),
                  wa.addListeners(),
